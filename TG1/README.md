...
<p> Atualmente sou Programador na empresa <a href="https://codex.tec.br/">Codex Utilities</a> trabalhando como Analista de Sistemas, minhas experiências obtidas ao longo dos projetos são de extrema importancia durante meu trabalho.</p>
...
<p>O projeto é uma parceria entre a FATEC – São José dos Campos e a empresa parceira <a href="https://www.spcbrasil.org.br/">SPC</a>. A proposta apresentada para a equipe Data Rangers, é a prototipação de um Data Warehouse que armazena os dados e possibilita, através do uso de modelos e reports a prospecção de novos clientes, o aumento das vendas e o consumo dos produtos SPC por meio de analise em gráficos na ferramenta Power BI utiizados pelos analistas de negócios</p>
